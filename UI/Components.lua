...
--   Tab buttons, toggle, section header
-- ================================================

local K          = getgenv().KalssUI
local tween      = K.tween
local makeCorner = K.makeCorner
local RAINBOW    = K.RAINBOW
local Sidebar    = K.Sidebar
local ContentArea = K.ContentArea
local TabButtons = K.TabButtons
local Tabs       = K.Tabs

-- ================================================
-- SECTION HEADER
-- ================================================
K.sectionHeader = function(parent, text, yPos)
...
-- TOGGLE
-- ================================================
K.makeToggle = function(parent, labelText, yPos, defaultOn, onToggle)
...
-- ACTIVATE TAB
-- ================================================
K.activateTab = function(name)
    if K.ActiveTab == name then return end
    K.ActiveTab = name
...
-- ================================================
-- BUAT SEMUA TAB BUTTONS (posisi manual, anti-overflow)
-- ================================================
local TAB_DATA = {
...
for i, data in ipairs(TAB_DATA) do
    ...
    btn.Position         = UDim2.new(0, 8, 0, 10 + (i - 1) * 42)
    ...
    btn.MouseButton1Click:Connect(function()
        K.activateTab(data.name)
    end)
end

-- Default tab
K.activateTab("Home")
print("[KalssSC] Components loaded!")    return f
end
